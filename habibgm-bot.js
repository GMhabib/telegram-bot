...
// -- Anti-flood settings
// const floodThreshold = 3; // Batas jumlah pesan dalam periode waktu
// const floodInterval = 3000; // Periode waktu dalam milidetik (3 detik)
// const userMessageCount = {};
// const lastMessageTime = {};

// -- Deteksi pesan berulang
// const duplicateMessageThreshold = 3; // Batas pesan sama dalam interval
// const duplicateMessageInterval = 3000; // Interval waktu (3 detik)
// const userLastMessages = {}; // Menyimpan pesan terakhir setiap user { userId: [{timestamp, text, messageId}] }

// -- Deteksi pesan berurutan yang sama
// const consecutiveDuplicateThreshold = 2; // Batas jumlah pesan berurutan yang sama untuk dihapus
// const userConsecutiveMessages = {}; // Menyimpan pesan berurutan terakhir { userId: {lastText, count, messageIds} }
...
function prosesPesan(update) {
  try {
    ...
    const bannedWords = [
        // Kata-kata asli Anda (beberapa mungkin tumpang tindih/redundant tapi tidak masalah)
        ...
        /k+a+m+p+r+e+t+/i,
        /t+o+l+o+l+/i,
        /g+o+b+l+o+k/i, // Bisa juga /g+o+b+l+o+[gk]/i untuk goblog/goblok
        /b+o+d+o+h+/i,
        /i+d+i+o+t+/i,
        /d+o+g+o+/i,
        /s+e+t+a+n+/i,
        ...
        /b+a+s+t+a+r+d+/i,
        /d+a+m+n+/i,
        /h+e+l+l+/i, // Mungkin terlalu umum? Pertimbangkan konteks.
                 ...
                 // Cek apakah pengguna yang memerintah adalah admin? (Implementasi sederhana)
                  ...
                  if (chatMember.status !== 'creator' && chatMember.status !== 'administrator') {
                   ...
                   if (unbanResult.ok) {
                       ...
                       bot.telegram.sendMessage(chatId, `❌ Gagal meng-unban pengguna ID <code>${userIdToUnban}</code>.\nError: ${unbanResult.description || 'Unknown error'}`, { parse_mode: 'HTML' });
